...
<!-- Mirrored from rxdtheme.com/html/tf/duralux-demo/auth-login-creative.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jun 2025 09:07:24 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="assest/images/favicon.ico">
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
...
<body>
                    ...
                    <div class="row flex-1 g-0">
                        <div class="col-lg-6 h-100 my-auto order-1 order-lg-0">
                            <div class="wd-50 bg-white p-2 rounded-circle shadow-lg position-absolute translate-middle top-50 start-50 d-none d-lg-block">
                                <img src="assest/images/logo-abbr.png" alt="" class="img-fluid">
                            </div>
                            <div class="creative-card-body card-body p-sm-5">
                                ...
                                <form action="Cont/login" method="post" class="w-100 mt-4 pt-2">
                                    <div class="mb-4">
                        ...
                        <div class="col-lg-6 bg-primary order-0 order-lg-1">
                            <div class="h-100 d-flex align-items-center justify-content-center">
                                <img src="assest/images/auth/auth-user.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!--! ================================================================ !-->
    <!--! BEGIN: Vendors JS !-->
    <script src="assest/vendors/js/vendors.min.js"></script>
    <!-- vendors.min.js {always must need to be top} -->
    <!--! END: Vendors JS !-->
    <!--! BEGIN: Apps Init  !-->
    <script src="assest/js/common-init.min.js"></script>
    <!--! END: Apps Init !-->
    <!--! BEGIN: Theme Customizer  !-->
    <script src="assest/js/theme-customizer-init.min.js"></script>
    <!--! END: Theme Customizer !-->
</body>
