...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>ACC-Shop </title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="../assest/images/favicon.png" />
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
    <link rel="stylesheet" type="text/css" href="../assest/css/bootstrap.min.css" />
    <!--! END: Bootstrap CSS-->
    <!--! BEGIN: Vendors CSS-->
    <link rel="stylesheet" type="text/css" href="../assest/vendors/css/vendors.min.css" />
    <link rel="stylesheet" type="text/css" href="../assest/vendors/css/daterangepicker.min.css" />
    <!--! END: Vendors CSS-->
    <!--! BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="../assest/css/theme.min.css" />
    <!--! END: Custom CSS-->
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="index.html" class="b-brand">
                    ...
                    <img src="../assest/images/logo.webp" alt="Logo" style="max-width: 150px; height: auto; display: block; margin: 0 auto; object-fit: contain; padding: 10px;" />

                    <img src="../assest/images/logo-abbr.png" alt="" class="logo logo-sm" />
                </a>
            </div>
            <div class="navbar-content">
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="home" class="nxl-link">
                            <span class="nxl-micon"><i class="feather-airplay"></i></span>
                            <span class="nxl-mtext">home</span><span class="nxl-arrow">
                        </a>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="admin_view"><i class="feather-users"></i> view admin</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="admin_add"><i class="feather-user-plus"></i> create admin</a></li>
                        </ul>
                    </li>
                   <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather-truck"></i></span>
                            <span class="nxl-mtext">Supplier</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="supplier"><i class="feather-eye"></i> view supplier</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="addsupplier"><i class="feather-plus"></i> create supplier</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="fa-solid fa-paper-plane"></i></span>
                            <span class="nxl-mtext">Delivery</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="delivery"><i class="feather-eye"></i> view Delivery</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="add_delivery"><i class="feather-plus"></i> create Delivery</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="products"><i class="feather-eye"></i> view products</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="addproducts"><i class="feather-plus"></i> create products</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="order"><i class="feather-eye"></i> view order</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="addorder"><i class="feather-plus"></i> create order</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="supplier_info"><i class="fa-solid fa-address-card"></i> supplier info</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="products_info"><i class="fa-solid fa-box"></i> products info</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="list_tables"><i class="feather-eye"></i> view File</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="addfile"><i class="feather-file-plus"></i> Add File</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="feather-file"></i></span>
                            <span class="nxl-mtext">Word Files</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="list_file"><i class="feather-eye"></i> view Word File</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="addword"><i class="feather-file-plus"></i> Add word File</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="edit_file"><i class="feather-file-plus"></i> Edit word File</a></li>
                        </ul>
                    </li>
            </div>
        </div>
                        ...
                        <div class="dropdown nxl-h-item nxl-lavel-menu">
                            ...
                            <div class="dropdown-menu nxl-h-dropdown">
                                ...
                                <div class="dropdown nxl-level-menu">
                                    ...
                                    <div class="dropdown-menu nxl-h-dropdown">
                                        <a href="admin_add" class="dropdown-item">
                                            <i class="wd-5 ht-5 bg-gray-500 rounded-circle me-3"></i>
                                    ...
                                    <div class="tab-content nxl-mega-menu-tabs-content">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                            <div class="mb-4 rounded-3 border">
                                                <img src="../assest/images/banner/mockup.png" alt="" class="img-fluid rounded-3" />
                                            </div>
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="../assest/images/general/full-avatar.png" alt="" class="img-fluid full-user-avtar" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                            <div class="row g-lg-4 nxl-mega-menu-integrations">
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/app-store.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/spotify.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/figma.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/shopify.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/paypal.png" alt="" class="img-fluid" />
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/gmail.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/dropbox.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/google-drive.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/github.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/gitlab.png" alt="" class="img-fluid" />
                                                        </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/facebook.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/pinterest.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/instagram.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/twitter.png" alt="" class="img-fluid" />
                                                        </div>
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item">
                                                        <div class="menu-item-icon">
                                                            <img src="../assest/images/brand/youtube.png" alt="" class="img-fluid" />
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="nxl-mega-menu-image">
                                                        <img src="../assest/images/banner/1.jpg" alt="" class="img-fluid" />
                                                    </div>
                                                    <div class="mt-4">
                                                    ...
                                                    <div id="carouselResourcesCaptions" class="carousel slide" data-bs-ride="carousel">
                                                        ...
                                                        <div class="carousel-inner rounded-3">
                                                            <div class="carousel-item active">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="../assest/images/banner/6.jpg" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="../assest/images/banner/5.jpg" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="../assest/images/banner/4.jpg" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="../assest/images/banner/3.jpg" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="../assest/images/banner/2.jpg" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                            ...
                                                            <div class="carousel-item">
                                                                <div class="nxl-mega-menu-image">
                                                                    <img src="../assest/images/banner/1.jpg" alt="" class="img-fluid d-block w-100" />
                                                                </div>
                                                                <div class="carousel-caption">
                                                        ...
                                                        <div class="col-xxl-10">
                                                            <div class="row g-4">
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="../assest/images/banner/1.jpg" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="../assest/images/avatar/1.png" alt="" class="img-fluid" />
                                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="../assest/images/banner/2.jpg" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="../assest/images/avatar/2.png" alt="" class="img-fluid" />
                                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="../assest/images/banner/3.jpg" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="../assest/images/avatar/3.png" alt="" class="img-fluid" />
                                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="d-lg-flex align-items-center gap-3">
                                                                        <div class="wd-150 rounded-3">
                                                                            <img src="../assest/images/banner/4.jpg" alt="" class="img-fluid rounded-3" />
                                                                        </div>
                                                                        <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                            <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="hstack gap-2 mt-3">
                                                                                <div class="avatar-image avatar-sm">
                                                                                    <img src="../assest/images/avatar/4.png" alt="" class="img-fluid" />
                                                                                </div>
                                                        ...
                                                        <div class="col-xxl-10">
                                                            <div class="row g-4">
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="../assest/images/banner/1.jpg" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="../assest/images/banner/2.jpg" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="../assest/images/banner/3.jpg" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="../assest/images/banner/4.jpg" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="../assest/images/banner/5.jpg" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                                                                ...
                                                                <div class="col-xxl-4 col-lg-6">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="wd-100 rounded-3">
                                                                            <img src="../assest/images/banner/6.jpg" alt="" class="img-fluid rounded-3 border border-3" />
                                                                        </div>
                                                                        <div>
                                                                            <a href="javascript:void(0);">
                                                                                <h6 class="menu-item-heading text-truncate-1-line">Lorem ipsum dolor sit</h6>
                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="search-items-wrapper">
                                ...
                                <div class="users-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image rounded">
                                                <img src="../assest/images/avatar/5.png" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                ...
                                <div class="file-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="../assest/images/file-icons/css.png" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="../assest/images/file-icons/zip.png" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="../assest/images/file-icons/pdf.png" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                    ...
                    <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                        <a href="javascript:void(0);" class="nxl-head-link me-0 nxl-language-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            <img src="../assest/vendors/img/flags/4x3/us.svg" alt="" class="img-fluid wd-20" />
                        </a>
                                ...
                                <div class="row px-4 pt-3">
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/sa.svg" alt="" class="img-fluid" /></div>
                                            <span>Arabic</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/bd.svg" alt="" class="img-fluid" /></div>
                                            <span>Bengali</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/ch.svg" alt="" class="img-fluid" /></div>
                                            <span>Chinese</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/nl.svg" alt="" class="img-fluid" /></div>
                                            <span>Dutch</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select active">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/us.svg" alt="" class="img-fluid" /></div>
                                            <span>English</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/fr.svg" alt="" class="img-fluid" /></div>
                                            <span>French</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/de.svg" alt="" class="img-fluid" /></div>
                                            <span>German</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/in.svg" alt="" class="img-fluid" /></div>
                                            <span>Hindi</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/ru.svg" alt="" class="img-fluid" /></div>
                                            <span>Russian</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/es.svg" alt="" class="img-fluid" /></div>
                                            <span>Spanish</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/tr.svg" alt="" class="img-fluid" /></div>
                                            <span>Turkish</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-4 col-6 language_select">
                                        <a href="javascript:void(0);" class="d-flex align-items-center gap-2">
                                            <div class="avatar-image avatar-sm"><img src="../assest/vendors/img/flags/1x1/pk.svg" alt="" class="img-fluid" /></div>
                                            <span>Urdo</span>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            ...
                            <div class="notifications-item">
                                <img src="../assest/images/avatar/2.png" alt="" class="rounded me-3 border" />
                            ...
                            <div class="notifications-item">
                                <img src="../assest/images/avatar/3.png" alt="" class="rounded me-3 border" />
                                <div class="notifications-desc">
                            ...
                            <div class="notifications-item">
                                <img src="../assest/images/avatar/4.png" alt="" class="rounded me-3 border" />
                                <div class="notifications-desc">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="../assest/images/avatar/1.png" alt="user-image" class="img-fluid user-avtar me-0" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="../assest/images/avatar/1.png" alt="user-image" class="img-fluid user-avtar" />
                                    <div>
